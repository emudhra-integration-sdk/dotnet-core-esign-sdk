...
using System.util;
using eSignLibrary.text.xml.simpleparser;
using eSignLibrary.text.error_messages;
using System.util.collections;
using eSignLibrary.text.exceptions;

namespace eSignLibrary.text.pdf {
    /// <summary>
    ...
    public abstract class BaseFont {
        ...
        private const string ARIAL = "ARIALUNI.TTF";
        internal static BaseFont GetArabicFont()
        {
            return CreateFont($"{RESOURCE_PATH}{ARIAL}", IDENTITY_H, EMBEDDED);
        }
        ...
        */    
        ...
        public const string RESOURCE_PATH = "eSign.eSignLibrary.text.pdf.fonts.";
