...
namespace eSignASPLibrary.Util
{
    ...
    {
        public static string GetRequestXML(List<eSignReturnDocument> returnDocuments, string ASPID, string ts, string txn, string signerID, string responseURL, string redirectURL, bool isLTVRequired)
        {
            try
            {
        ...
        public static string GetStatusXML(string ASPID, string ts, string txn)
        {
            XmlDocument RequestXml = new XmlDocument();
        ...
        //public static string SignXML(string XMLValue)
        //{
        //    try
        //    {
        //        string SignedXML = string.Empty;
        //        string PFXFilePath = eSignSettings.pfxPath;
        //        string PFXPassword = eSignSettings.pfxPassword;
        ...
        //        var exportedKeyMaterial = rsa.ToXmlStringExt(true);
        //        var key = new RSACryptoServiceProvider();
        //        key.PersistKeyInCsp = false;
        //        key.FromXmlStringExt(exportedKeyMaterial);
        ...
        internal static string SignXML(string XMLValue)
        {
            ...
            // using (Stream s = StreamUtil.GetResourceStream("EmdhaLibrary.Emdha.DSIGRI.xsd"))
            // {
            //    XmlPreloadedResolver resolver = new XmlPreloadedResolver();
            //    resolver.Add(new Uri("http://www.w3.org/2000/09/xmldsig"), s);
            ...
            signedXml.SigningKey = GetRSA(Cert);
            Reference reference = new Reference();
            reference.AddTransform(new XmlDsigEnvelopedSignatureTransform());
            reference.Uri = "";
            signedXml.AddReference(reference);
        ...
        public static string HttpsWebClientSendRequest(string URI, string queryString)
        {
        ...
        public static string GenerateTempTransactionData(List<eSignReturnDocument> returnDocuments)
        {
            try
            {
